...
------------------>
        ...
        if ($_SERVER['REQUEST_METHOD']=='POST') {
            ...
            if ($msg=="") {
                $results = $om->View("customer", "*","", array("id" => $_SESSION['id']));
                ...
                if($om->update("customer", $data,array("id" => $_SESSION['id']))){
                    echo "<script>window.location='index.php?c=customer-view&edit=Update'</script>";
                }
                else{
                    ?>
        ...
        ?>
            ...
            $results = $om->View("customer", "*", "", $where);
            while ($result = $results->fetch_object()) {
        ?>

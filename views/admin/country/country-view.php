...
<div class="col-lg-9 col-12 order-1 order-lg-2">
  <div class="row">
    <div class="col-lg-8">
      <h3 class="wedget__title">View Country</h3>
      <div class="mb-3">
    ...
    if ($data->num_rows > 0) {
        $count = 0;
          while($d = $data->fetch_object()) {
            ...
            echo "<td>{$d->name}</td>";
            echo "<td width=10>
						  <a class='text-white btn btn-warning' href='index.php?a=country-edit&mmh={$d->id}'>Edit</a>
						</td>";
						echo "<td width=10>
						  <a class='text-white btn btn-danger' href='index.php?a=country-delete&mmh={$d->id}'onclick=\"return confirm('Are you sure you want to delete this item?');\">Delete</a>
						</td>";
            echo "</tr>";
        }
    } 

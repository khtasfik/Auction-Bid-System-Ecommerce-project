      ...
      $count = 0;
        while($d = $data->fetch_object()) {
          $count++;
            ...
            echo "<td>{$cuid}</td>";
            echo "<td width=10>
						  <a class='text-white btn btn-warning' href='index.php?a=sub-category-edit&mmh={$d->id}'>Edit</a>
						</td>";
						echo "<td width=10>
						  <a class='text-white btn btn-danger' href='index.php?a=sub-category-delete&mmh={$d->id}'onclick=\"return confirm('Are you sure you want to delete this item?');\">Delete</a>
						</td>";
            echo "</tr>";
        }
    } 
